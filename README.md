...
**[BridgeCrane17/discord-fix-1.8.0](https://github.com/BridgeCrane17/discord-fix-1.8.0)** — сборка для Windows 10/11

[**⬇ Скачать последний релиз**](https://github.com/BridgeCrane17/discord-fix-1.8.0/releases/latest)
...
> Если вы наткнулись на что-то вне репозитория `BridgeCrane17/discord-fix-1.8.0`, что распространяется от моего лица — **ФЕЙК**.
...
1. Откройте [**Releases → Latest**](https://github.com/BridgeCrane17/discord-fix-1.8.0/releases/latest) и скачайте **`.rar`** (предпочтительно)
